...
import preImg from "../assets/images/bisis_logo.png"
...
const PreLoader = ({ onComplete }: { onComplete: () => void }) => {
    ...
    return (
        <div className="preloader fixed inset-0 flex flex-col items-center justify-end pb-20 z-[9999] text-milk bg-dark-brown">
            {/* <h1 className="text-7xl font-bold tracking-widest lg:mb-30">BISI'S BITES</h1> */}
            <img src={preImg} alt="pre img" className="lg:mb-40 mb-[60%] lg:w-[20%] w-[40%] rounded-full shadow-2xl border-4 border-mid-brown" />
            <p className="lg:text-[2rem] text-[1.5rem] tracking-wider">{progress}%</p>
            <div className="mt-2 lg:w-[12rem] w-64 h-1 bg-black/30 rounded-full overflow-hidden">
                <div
                    className="h-full bg-milk transition-all duration-150 ease-linear"
